...
jenkinsfileURL = "https://github.com/sebastiansutter/my_apic_jenkins_test" //Eg: https://github.com/abhinabsarkar/apiconnect-pipeline-jenkins/blob/master/src/Jenkinsfile
